...
List<Map<String, dynamic>> productsMock = [
  ...
  },
  {
    ...
    'categoryId': "01",
    'images': [
      "https://svetofornadom.ru/upload/resize_cache/iblock/8d5/y5qdtxqbmj9wtgym1d8cq4j5ozrtg51j/1000_666_1/Grapes_White_background_Multicolor_567645_2560x1706.jpg",
      "https://kupimir.club/upload/iblock/a2a/a2a5d4246769a3673b2fcfc525423484.jpg",
    ],
    'createdDate': DateTime(2022, 8, 21, 14).toString(),
    'size': "1",
    'companyName': "Uz Garden",
  ...
  // drinks
  {
    ...
    'categoryId': "02",
    'images': [
      "https://mosnapitki.ru/upload/iblock/535/p98w437iehwp515mybumaudg45x3egxy.png",
    ],
    'createdDate': DateTime(2022, 8, 21, 14).toString(),
    'size': "1",
    'companyName': "Nestle",
  ...
  },
  {
    ...
    'categoryId': "02",
    'images': [
      "https://ae01.alicdn.com/kf/U8bcc8acf92f9429f959a313242bde6b1d/7UP-1-5.jpg",
    ],
    'createdDate': DateTime(2022, 8, 21, 14).toString(),
    'size': "1",
    'companyName': "Coca Cola",
